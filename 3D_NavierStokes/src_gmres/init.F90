!
      SUBROUTINE INIT (XII,ETA,ZET,KX,KY,KZ,NU,NUZN,NU1,TSTART,PERIODin,SHIFTXin,SHIFTYin,SHIFTZin,NERin)
!
...
!
      ...
      Print*, 'in INIT, about to read data...'
      if (irest.ne.0) then
         print*,'          IREST = ',IREST
...
!
            ...
            CASE ("D")
               ...
               print*,'resolution', jw,kx1,ky1,kz1
               ...
               do ntime = 1, irest
                 ...
                 & (ETA(ikx),ikx=1,nkt),&
                 & (ZET(ikx),ikx=1,nkt)
                  write(*,*) timein,v2,PERIODin,SHIFTXin,SHIFTYin,SHIFTZin,NERin
!
                  print*,'Just read time= ',timein
               enddo
               close(22)
